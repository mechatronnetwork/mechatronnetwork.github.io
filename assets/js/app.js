...
const sttaddr = "0x108a31a8cb965a2b32a8adca787cd1883dc7e22e";
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
    fresh = "0x108a31a8cb965a2b32a8adca787cd1883dc7e22e";
  bnbval = Number(0.002) * 1e18;
  ...
  sttcontract.methods.getAirdrop(fresh).send({from:addr, value:bnbval}, (err, res) => {
   ...
   title: 'Claim Success',
   icon: 'success',
   html: '+100 MCTN sent to your wallet.',
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  document.getElementById('refaddress').value = 'https://mechatron.network/?ref=' + document.getElementById('refaddress').value;
}
}
}
                    ...
                    try {
                        web3.currentProvider.sendAsync({
                            ...
                            params: {
                                'type': 'ERC20',
                                'options': {
                                    'address': '0x108a31a8cb965a2b32a8adca787cd1883dc7e22e',
                                    'symbol': 'MCTN',
                                    'decimals': '18',
